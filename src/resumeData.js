let resumeData = {
    ...
    "socialLinks":[
        {
          "name":"linkedin",
          "url":"https://www.linkedin.com/in/i%C3%B1igo-mu%C3%B1oz/",
          "className":"fa fa-linkedin"
        },
        {
          "name":"github",
          "url":"https://github.com/luthiwd",
    ...
    "portfolio":[
      {
        ...
        "description": "API REST en Node.js para gestión de contraofertas en ecommerce. Permite aceptar ofertas automáticamente según margen de descuento, generar cupones, gestionar revisión manual por admin, autenticación JWT, notificaciones por email y panel de administración. Proyecto desplegado en Railway.",
